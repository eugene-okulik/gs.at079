...
@allure.title('Тест функциональности №1.1')
...
@allure.title('Тест функциональности №1.2')
...
@allure.title('Тест функциональности №1.3')
def test_3_1():
    assert 3 == 3
...
@allure.story('story_1')
@allure.title('Тест функциональности №2.1')
def test_4_1():
    assert 4 == 4
